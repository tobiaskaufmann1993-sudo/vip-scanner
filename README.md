...
9. فقط کانفیگ‌هایی را می‌پذیرد که:
   ...
   - Median تأخیر حداکثر `1000ms` باشد.
10. کانفیگ‌های حداکثر `500ms` را در گروه Elite و کانفیگ‌های `500–1000ms` را در گروه Acceptable قرار می‌دهد.
11. روی بهترین ۴۰ گزینه، دانلود کوچک ۲۵۶ کیلوبایتی انجام می‌دهد.
...
```json
{
  ...
  "quality": {
    "elite": 34,
    "acceptable": 16,
    "elite_threshold_ms": 500,
    "maximum_threshold_ms": 1000
  },
  "safety_mode": "normal"
}
```
